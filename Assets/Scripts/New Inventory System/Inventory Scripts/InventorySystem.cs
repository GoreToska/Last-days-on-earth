...
public class InventorySystem
{
	...
	public InventorySystem(int size, List<ItemPair> preparedItems)
	{
		InventorySlots = new List<InventorySlot>(size);
		...
		{
			InventorySlots[i].AssignItem(new InventorySlot(preparedItems[i].Item, preparedItems[i].Count));
		}
	}
