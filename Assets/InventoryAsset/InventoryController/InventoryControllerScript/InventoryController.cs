...
namespace InventorySystem
{
    ...
    public class InventoryController : MonoBehaviour
    {
        ...
        // ADDITIONAL
        [SerializeField] private InventoryUIManager _mainInventoryUI;
        ...
        {
            LoadSave();
            PlayerInputManager.Instance.OpenInventoryEvent += OpenMainInventory;
            PlayerInputManager.Instance.CloseInventoryEvent += CloseMainInventory;
        }

        private void OnEnable()
        {
            // TODO zenject and enable disable input
        }
        ...
        private bool TestItemDict(string itemType)
        {
            ...
            {
                Debug.LogError("No existing item with name: " + itemType + ". Add item to item manager in Inventory Controller");
                return false;
            }
        }
        ...
        /// </summary>
        /// in future maybe make another version of this method to operate with crates
